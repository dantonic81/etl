from etl.main import parse_url, create_table, check_record_exists, batch_insert_records, main
...
def test_main(mocker, mock_pd, mock_establish_connection):
    ...
    mock_df['url'] = ['https://example.com?a_bucket=value1&a_type=value2&a_source=value3']
    mock_df['parsed_data'] = [{'ad_bucket': 'value1', 'ad_type': 'value2', 'ad_source': 'value3'}]
